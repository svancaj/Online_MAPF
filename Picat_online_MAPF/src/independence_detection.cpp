...
int IndependenceDetection::PlanForGroups(int time, int g1, int g2, int SoC)
{
	...
	string executable;
	executable = string("timeout ").append(to_string(instance->timeout - current_runtime/1000)).append(string(" ./picat soc ")).append(instance->solver_input_filename).append(" > ").append(instance->solver_output_filename);
...
void IndependenceDetection::FixGoalPosition()
{
	int max_timestep = 0;
